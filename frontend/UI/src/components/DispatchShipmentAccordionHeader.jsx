...
import { getDispatchPDF } from "../services/dispatchpdf.service";
/* eslint-disable react/prop-types */
export default function DispatchShipmentAccordionHeader({
  isActive,
  shipment,
}) {
  return (
      ...
      >
        ...
        <div>
          <button
            ...
            onClick={(e) => {
              e.stopPropagation();
              getDispatchPDF(shipment);
            }}
          >
            <DocumentArrowDown className={"size-5"} />
